<?php
    ...
    class DetailsViewOnlyForUserOwnerEditAndDetailsViewDesignerRules extends EditAndDetailsViewDesignerRules
    {
        public function getSavableMetadataRules()
        {
            $savableMetadataRules       = parent::getSavableMetadataRules();
