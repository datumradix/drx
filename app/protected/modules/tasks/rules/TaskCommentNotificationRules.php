<?php
     ...
     */
    class TaskCommentNotificationRules extends TaskNotificationRules
    {
        ...
        {
            return Zurmo::t('TasksModule', 'Task comment creation or modification');
        }
        ...
        {
            return 'task-comment-notification-tooltip';
        }

        public function getTooltipTitle()
        {
            return Zurmo::t('UsersModule', 'Notify me when new comment is added or updated existing on tasks I am following.');
        }
        ...
        {
            return Zurmo::t('TasksModule', 'Comment added or updated for {relatedModel}: {task}', $this->getParamsForEmailSubject());
        }
    }
?>