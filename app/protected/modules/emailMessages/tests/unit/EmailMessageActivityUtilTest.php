...
//        }
        ...
        public function testGetByEmailMessageId()
        {
            ...
            //Ask jason not working
            //$tobeTestedCamapignItems = EmailMessageActivityUtil::getByEmailMessageId('CampaignItem', $campaignItems[0]->emailMessage->id);
            //$this->assertEquals($campaignItem->id, $tobeTestedCamapignItems[0]->id);
        }
    }
?>