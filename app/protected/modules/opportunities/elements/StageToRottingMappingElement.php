<?php
    ...
    /**
     * Class to help manage the stage to rotting mapping for opportunities. This is used by designer.
     */
    class StageToRottingMappingElement extends TextElement
    {
        /**
        ...
        {
            $content    = null;
            $content   .= ZurmoHtml::textField('stageToRottingMapping_notUsed', null,
            ...
            $stageToRotting = OpportunitiesModule::getStageToRottingMappingData();
            foreach ($values as $value)
            {
                if (isset($stageToRotting[$value]))
                {
                    $rotting = $stageToRotting[$value];
                }
                else
                {
                    $rotting = 0;
