<?php
    ...
    /**
     * Helper class with functions to assist in working with Opportunities module.
     */
    class OpportunitiesUtil
    {
        /**
        ...
        public static function renderTimeInStageForListView($model)
        {
            ...
            if (OpportunitiesModule::isRottingMappingEnabled() && $stageRottingValueInDays != 0)
            {
                ...
                {
                    $class      = 'opportunity-time-stage completed';
                    $content    = '<i>&#9679;</i>' . $span;
                }
                else
                {
                    $class      = 'opportunity-time-stage paused';
                    $content    = '<i>&#9679;</i>' . $span;
                }
            }
            else
        ...
        public static function renderTimeInStageForRelatedListView($model)
        {
            ...
            if (OpportunitiesModule::isRottingMappingEnabled() && $stageRottingValueInDays != 0)
            {
                if ($timeInStageInDays < $stageRottingValueInDays)
                {
                    $class      = 'opportunity-time-stage-related completed';
                    $content    = Zurmo::t('OpportunitiesModule', 'Time in stage') . ': ' . '<i>&#9679;</i>' . $span;
                }
                else
                {
                    $class      = 'opportunity-time-stage-related paused';
                    $content    = Zurmo::t('OpportunitiesModule', 'Time in stage') . ': ' . '<i>&#9679;</i>' . $span;
                }
            }
            else
        ...
        public static function renderTimeInStageForKanbanView($model)
        {
            ...
            if (OpportunitiesModule::isRottingMappingEnabled() && $stageRottingValueInDays != 0)
            {
                if ($timeInStageInDays < $stageRottingValueInDays)
                {
                    $class      = 'opportunity-time-stage-kanban completed';
                    $content    = Zurmo::t('OpportunitiesModule', 'Time in stage') . ': ' . '<i>&#9679;</i>' . $timeInStageDisplayContent;
                }
                else
                {
                    $class      = 'opportunity-time-stage-kanban paused';
                    $content    = Zurmo::t('OpportunitiesModule', 'Time in stage') . ': ' . '<i>&#9679;</i>' . $timeInStageDisplayContent;
                }
            }
            else
