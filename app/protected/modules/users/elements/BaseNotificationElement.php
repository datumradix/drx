<?php
    ...
    /**
     * Display 2 checkboxes to activate inbox and email notifications respectively
     */
    class BaseNotificationElement extends Element
    {
        ...
        protected function renderControlEditable()
        {
            ...
            return ZurmoHtml::tag('div', array('class' => 'enableInboxAndEmailNotifications'), $content);
        }
        ...
        protected function renderLabel()
        {
            ...
            $content .= $this->renderTooltipContentForNotification();
            return $content;
        }
