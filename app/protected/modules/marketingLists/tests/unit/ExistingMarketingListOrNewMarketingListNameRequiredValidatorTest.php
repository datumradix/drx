<?php
    ...
    class ExistingMarketingListOrNewMarketingListNameRequiredValidatorTest extends BaseTest
    {
        public function testValidate()
        {
            ...
            $form->newMarketingListName = null;
            $form->marketingList = 'BBB'; // Wrong format
            $this->assertFalse($form->validate());
            $errors = $form->getErrors();
            $this->assertEquals(1, count($errors));
            $this->assertTrue(isset($errors['marketingList']) && is_array($errors['marketingList']));
