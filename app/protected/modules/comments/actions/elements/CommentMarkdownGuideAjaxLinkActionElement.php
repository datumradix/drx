<?php
    ...
    class CommentMarkdownGuideAjaxLinkActionElement extends AjaxLinkActionElement
    {
        public function getActionType()
        {
            return 'CommentMarkdownGuide';
        }
        ...
        {
            return Zurmo::t('CommentsModule', 'Markdown Guide');
        }

        protected function getDefaultRoute()
        {
            return Yii::app()->createUrl($this->moduleId . '/' . $this->controllerId . '/markdownGuide/');
        }
        ...
        protected function getHtmlOptions()
        {
            ...
            $defaultHtmlOptions  = array('id' => 'comment-markup-guide', 'class' => 'simple-link');
