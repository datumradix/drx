<?php
    ...
    /**
     * Comments Module Super User Walkthrough.
     * Walkthrough for the super user of all possible controller actions.
     * Since this is a super user, he should have access to all controller actions
     * without any exceptions being thrown.
     */
    class CommentsSuperUserWalkthroughTest extends ZurmoWalkthroughBaseTest
    {
        ...
        public function testAddingCommentsOnAccount()
        {
            ...
            $account = AccountTestHelper::createAccountByNameForOwner('testAccount2', $super);

            $this->assertEquals(0, $account->comments->count());
            $this->assertEquals(0, Yii::app()->emailHelper->getQueuedCount());
            $this->assertEquals(0, Yii::app()->emailHelper->getSentCount());
            $this->assertEquals(0, Notification::getCount());

            //Validate comment
            $this->setGetArray(array('relatedModelId'             => $account->id,
            ...
            $this->assertEquals(1, $account->comments->count());
        }
    }
?>
