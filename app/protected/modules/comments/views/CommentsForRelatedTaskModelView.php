<?php
     ...
     *
     */
    class CommentsForRelatedTaskModelView extends CommentsForRelatedModelView
    {
        /**
         * @return string
         */
        ...
        protected function renderShowAllLinkContent()
        {
            ...
            return       ZurmoHtml::ajaxLink(Zurmo::t('CommentsModule', 'Show older comments'), $url,
                         array('type' => 'GET',
                               'success' => 'function(data){$("#CommentsForRelatedTaskModelView' . $this->uniquePageId . '").replaceWith(data)}'),
                         array('id'         => 'showAllCommentsLink' . $this->getId(),
