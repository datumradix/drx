<?php
    ...
    /**
     * A  NotificationRules to manage when a new task for project is created
     */
    class ProjectTaskAddedNotificationRules extends ProjectNotificationRules
    {
        /**
        ...
        {
            return Zurmo::t('ProjectsModule', 'NEW TASK: {task} for PROJECT: {project}', $this->getParamsForEmailSubject());
        }
    }
?>