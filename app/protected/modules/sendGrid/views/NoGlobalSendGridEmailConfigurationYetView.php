<?php
    ...
    /**
     * View  for showing in the user interface when there the global sendgrid email configuration is not yet set up.
     * This needs to be configured first before a user's email configuration can be setup.
     */
    class NoGlobalSendGridEmailConfigurationYetView extends View
    {
        ...
        protected function getMessageContent()
        {
            return Zurmo::t('SendGridModule', '<h2>Not so fast</h2>' .
                                     '<div class="large-icon"></div><p>The administrator must first configure the sendgrid global email settings.</p>');
        }
    }
?>