     ...
     * emails.
     */
    Yii::import('application.commands.EmailCommand');
    class EmailTestCommand extends EmailCommand
    {
        /**
        ...
        {
            parent::setEmailHelperSettings($host, $port, $outboundUsername, $outboundPassword, $outboundSecurity);
