<?php
    ...
    class ZurmoHtmlPurifier extends CHtmlPurifier
    {
        /**
         * @inheritdoc
         */
        ...
        {
            $purifier   = $this->getPurifierInstance();
         ...
         * @return int
         */
        protected function resolveDefaultSerializerPermissions()
        {
            return 0777;
        }
        ...
        {
            $purifier   = new HTMLPurifier($this->resolveOptions());
            return $purifier;
        }
        ...
        {
            return CMap::mergeArray($this->resolveDefaultOptions(), $this->options);
        }
    }
?>